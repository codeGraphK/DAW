...
public class MainFacturaOptgroup {
    ...
    public static void main(String[] args) throws IOException, NumberFormatException {
        ...
        for(int iCont = 0; iCont < FacturasCreadas.length;iCont++) {
            ...
            System.out.println("Escoge el precio por Litro:");
            System.out.print("1.- 0,6€/litro\n2.- 3€/litro\n3.- 1,25€/litro\n");
            switch(rdAll.readLine()){
                case "1":
                    FacturasCreadas[iCont].setPrecioLitro(0.6);
                    break;
                case "2":
                    FacturasCreadas[iCont].setPrecioLitro(3.0);
                    break;
                default:
                    FacturasCreadas[iCont].setPrecioLitro(1.25);
                    break;
            }
        }
